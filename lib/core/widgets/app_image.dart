...
class AppImage extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                Icon(
                  ...
                  size: (width != null && height != null) ? (width! < height! ? width! * 0.3 : height! * 0.3) : 30,
  ...
  bool _isSvg(String url) {
    return url.toLowerCase().contains('.svg') || url.toLowerCase().contains('svg');
  }
  ...
  bool _isAssetImage(String url) {
    return url.startsWith('assets/') || url.startsWith('images/') || !url.contains('/') && !url.startsWith('http');
  }
